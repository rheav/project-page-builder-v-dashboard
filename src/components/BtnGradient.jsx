function BtnGradient({ children, clickEvent }) {
	return (
		<button
			onClick={clickEvent}
			className="relative w-40 px-10 py-2 font-light text-white transition-all duration-200 rounded-md shadow bg-gradient-to-r from-startCold to-endCold group hover:shadow-xl hover:shadow-blue-300/75"
		>
